...
pub enum UpdateAction {
    /// Update via `npm install -g @aryanxispe/codex-termux@latest`.
    NpmGlobalLatest,
    /// Update via `bun install -g @aryanxispe/codex-termux@latest`.
    BunGlobalLatest,
    ...
    pub fn command_args(self) -> (&'static str, &'static [&'static str]) {
        match self {
            UpdateAction::NpmGlobalLatest => (
                "npm",
                &["install", "-g", "@aryanxispe/codex-termux@latest"],
            ),
